...
def gcd_of_last_digits(int_one, int_two)
  last1 = last_digit(int_one)
  last2 = last_digit(int_two)
  return last1.gcd(last2)
end
...
def int_remainder_without_modulo(i_dividend, i_divisor)
  ...
  # return 0 if i_dividend == i_divisor
  # continue = true
  # remainder = i_dividend
  # while continue
  #   remainder -= i_divisor
  #   return remainder  if remainder < i_divisor
  # end
  dec_remainder = dec_remainder_of_two_integers(i_dividend, i_divisor)
  return (dec_remainder * i_divisor).round
end
