class Hangman
  ...
  def initialize(players)   #receive an options hash
...
class HumanPlayer
  #let the user pick a word, word length
  #The human should tell the computer the positions
  #(if any) where the guessed letter occurs.
...
class ComputerPlayer
  #computer player should read in a dictionary file
