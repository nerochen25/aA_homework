    ...
    context "attribute readers" do
      describe "#guesser" do
        it "returns the game's guessing player" do
          expect(game.guesser).to be(players[:guesser]) #done
        end
      end

      describe "#referee" do
        it "returns the game's checking player" do
          expect(game.referee).to be(players[:referee]) #done
        end
      end
